...
import {incomes, incomesSum, incomesDatabaseName, allIncomes} from '../stores/incomesStore';
...
export {openIncomesDatabase, setIncomes, addIncome, updateIncome, deleteIncome}